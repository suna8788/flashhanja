...
var yin01 = Paper.image('../img/yin01.png', 0, 0, 70, 70).toDefs();
var yin02 = Paper.image('../img/yin02.png', 0, 0, 70, 70).toDefs();
var yin03 = Paper.image('../img/yin03.png', 0, 0, 70, 70).toDefs();
...
topArea.text(75, 93, '#칼날').attr({
    'font-size': 20,
    'fill': 'blue'
});

function handler01() {
    var audio1 = new Audio('../aud/yin01.wav');
    audio1.play();
}
...
var yin01 = yin01.use().transform('t130, 120').appendTo(bottomArea).attr({
    'visibility': 'hidden'
});
...
setTimeout(function() {
    ...
    function handler02() {
        var audio2 = new Audio('../aud/yin02.wav');
        audio2.play();
    }

}, 2000);

var yin02 = yin02.use().transform('t130, 250').appendTo(bottomArea).attr({
    'visibility': 'hidden'
});
...
var yin03 = yin03.use().transform('t130, 380').appendTo(bottomArea).attr({
    'visibility': 'hidden'
});
...
var yin04 = bottomArea.text(130, 575, '刃').attr({
    'font-family': 'notosans',
    'font-size': 80,
    'fill': 'none'
});
setTimeout(function() {
    yin04.click(handler03).attr({
        'fill': 'black',
        'cursor':'pointer'
    });

    function handler03() {
        var audio3 = new Audio('../aud/yin03.wav');
        audio3.play();
    }
