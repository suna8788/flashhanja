...
//이미지
var gung01 = Paper.image('../img/gung01.png', 0, 0, 130, 130).toDefs();
...
gung01.use().transform('t120, 140').appendTo(body);
body.text(180, 420, '弓').attr({
  'font-size': 150,
  'text-anchor': 'middle'
});
...
//
// bottomArea.rect(215, 535, 100, 40, 10).attr({
//     'fill': '#EAFF9A'
// });
//
// bottomArea.text(238, 563, '자원 보기').click(handlerOri).attr({
//     'font-size': 16,
//     'cursor':'pointer',
//     'font-weight':'bold'
// });
