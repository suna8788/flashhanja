...
bottomArea.text(160, 170, '至').click(handler01).attr({
...
function handler01() {
    var audio1 = new Audio('../aud/ji03.wav');
    audio1.play();
}
...
bottomArea.text(160, 300, '至大').click(handler02).attr({
    'font-family': 'notosans',
    'font-size': 26,
    'cursor':'pointer'
});
...
function handler02() {
    var audio2 = new Audio('../aud/voca06.wav');
    audio2.play();
}

var t1 = bottomArea.text(20, 420, ['* 오빠는 그림에 대한 관심이', '至大', ' 합니다.']).attr({
    'font-family': 'notosans',
    'font-size': 20
});
...
var r1 = bottomArea.rect(35, 430, 50, 40, 6).attr({
    'fill': '#86B2FF'
});

var q1 = bottomArea.text(55, 460, '?').attr({
    'fill': 'black',
    'font-size': 24,
    'font-weight':'bold'
});
...
function handlerAft() {
    location.replace('bon_03BV-04.html');
}
